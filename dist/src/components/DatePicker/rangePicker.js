...
export var FRCRangePicker = function (props) {
    var _a;
    ...
    var options = __assign({ className: classes, prefixIcon: prefixIcon, dropdownClassName: classesDropdown, showTime: showTime, suffixIcon: suffixIcon, onChange: function (dates, dateStrings) {
