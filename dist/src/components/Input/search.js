...
export var FRCSearch = function (props) {
    var _a;
    ...
    var classes = classNames('frc-input', className, (_a = {},
        ...
        _a["frc-input-search-loading"] = loading,
        _a));
    ...
    // main
    return React.createElement(Search, __assign({}, options));
};
// normal
FRCSearch.defaultProps = {
    bordered: true,
    enterButton: React.createElement(FiSearch, null),
};
