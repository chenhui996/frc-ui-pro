...
export var FRCTimePicker = function (props) {
    var _a, _b;
    var _c = useState(''), dateValue = _c[0], setDateValue = _c[1];
    var nodes = useRef(null);
    var className = props.className, prefixIcon = props.prefixIcon, popupClassName = props.popupClassName, showTime = props.showTime, suffixIcon = props.suffixIcon, format = props.format, onChange = props.onChange, onOpenChange = props.onOpenChange, restProps = __rest(props
    // add prefix node
    , ["className", "prefixIcon", "popupClassName", "showTime", "suffixIcon", "format", "onChange", "onOpenChange"]);
    // add prefix node
    useEffect(function () {
    ...
    var classesDropdown = classNames('frc-date-picker-dropdown frc-time-picker-dropdown', popupClassName, (_b = {},
        ...
        _b));
    var options = __assign({ className: classes, prefixIcon: prefixIcon, popupClassName: classesDropdown, showTime: showTime, suffixIcon: suffixIcon, format: format, onChange: function (value, dateString) {
    ...
    return (React.createElement("div", { ref: nodes, className: "frc-date-picker-container" },
        React.createElement(TimePicker, __assign({}, options))));
};
// normal
